...
function RegisterPage() {
    ...
    const handleLoginSubmit = async (e) => {
        e.preventDefault();
        let payload = {
            email, username, password, password_confirmation: passwordConfirm
        };
                ...
                <Form id={"loginForm"} onSubmit={handleLoginSubmit}>
                    ...
                    <div className={"col-12"}>
                        <div className={"row mt-3 w-100"}>
                            <Form.Group controlId="formBasicUsername" className={"col-10 mx-auto"}>
                                <Form.Control type="text" placeholder="Username" onChange={(e) => {
                                    setUsername(e.target.value)
                                }}/>
                                {errors && errors.username && <p className={"text-danger"}> {errors.username[0]}</p>}
                            </Form.Group>
                        </div>
                    </div>
                    <div className={"col-12"}>
                    ...
                    <div className={"col-12"}>
                        <div className={"row mt-3 w-100"}>
                            <Form.Group controlId="formBasicPasswordConfirm" className={"col-10 mx-auto"}>
                                <Form.Control type="password" placeholder="Conferma Password" className={"mb-1"}
                                              onChange={(e) => {
                    ...
                    <div className={"col-12"}>
                        <div className={"row mt-4 w-100"}>
                            ...
                            <div className={"col-7 offset-1 mb-4"}>
                                ...
                                <Link to={"/login"} className={"ml-3"}>Registrati</Link>
                            </div>
                        </div>
                    </div>
                </Form>
