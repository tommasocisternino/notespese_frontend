    ...
    render() {
        return (
            <RouteContext.Provider value={this.state}>
                <RoutesComponent routes={reactComponentsToArray(getRoutesIndexedArray())}/>
                {this.props.children}
...
const getRoutesIndexedArray = () => {
    ...
    routes["add"] = {
        ...
        addToNavBar: true,
        ReactRouteComponent: <Route path={"/add"} element={<AddMovementPage/>} key={"route_add"}/>,
    };
    routes["account"] = {
        path: "/account",
        name: "account",
        ...
        addToNavBar: true,
        ReactRouteComponent: <Route path={"/account"} element={<AccountPage/>} key={"route_account"}/>,
    };
    routes["login"] = {
        path: "/login",
        name: "login",
        ...
        icon: AccountCircleIcon,
        addToNavBar: false,
        ReactRouteComponent: <Route path={"/login"} element={<LoginPage/>} key={"route_login"}/>,
    };
    routes["register"] = {
        path: "/register",
        name: "register",
...
const RoutesComponent = ({routes}) => {
    return (
        <Routes>
            {routes.map((RouteComponent) => RouteComponent)}
        </Routes>
    );
}
